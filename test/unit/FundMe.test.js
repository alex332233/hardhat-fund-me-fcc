...
describe("FundMe", async function () {
    ...
    !developmentChains.includes(network.name)
        ...
        : beforeEach(async function () {
              ...
              fundMe = await ethers.getContract("FundMe", deployer) // the most recent deployed contract
    ...
    describe("withdraw", async function () {
        ...
        it("Withdraw ETH from a single founder", async function () {
            ...
            assert.equal(
                startingFundMeBalance.add(startingDeployerBalance).toString(), // it's big number, thus we use .add() instead of +
